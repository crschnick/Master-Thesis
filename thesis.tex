...
However, in theory it should not be too difficult to develop an algorithm that automatically determines optimal lo-fu surrogate configuration parameters by generating lo-fi surrogates with different parameters until a representative one is found.
