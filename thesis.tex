...
An alternative surrogate construction scheme is sparse grid based \cite{Pflueger2010}.
...
\end{equation}
This approach of computing the $\alpha_{\underline{\ell},\underline{i}}$ is slower compared to interpolation because 
