...
The \red box identifies the high-fidelity subpipeline components and the \green box identifies the low-fidelity subpipeline components.}
\label{fig:tpex}
\end{figure}
\end{mdframed}
...
\includegraphics[width=\textwidth]{graphics/wingweight_fixed}
\delimit
\captionof{figure}{Comparision of approximation errors for transformed sparse grids constructed in various different ways.}
\label{fig:ww_comp}
\end{figure}
\end{mdframed}
