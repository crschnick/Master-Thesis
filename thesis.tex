...
\delimit
	\captionof{figure}{Gradient approximation error $\varepsilon_{\text{grad}}$ of the previously introduced approximation methods on the left, and the resulting active subspace error $\varepsilon_{\text{AS}}$ on the right, computed for the example function $f_1$ as the average over 10 iterations.}
...
\begin{minipage}{.4\textwidth}
        \centering
  \captionof{figure}{Histogram of lo-fi approximation errors for $10^3$ randomly generated transformations with $r=3$, a bin range of $?$, and .. . The lowest error is $?$ and the highest one is $?$.\\The surrogates were created using regression.}
\label{fig:aligned_grid}
    \end{minipage}%
    \begin{minipage}{0.6\textwidth}
        \centering
...
\begin{subfigure}{.5\textwidth}
  \centering
   \includegraphics[width=\linewidth]{graphics/random_hist_3}
  \captionof{figure}{Random transformation approximation error distribution for $r=2$.}
  \label{fig:as_rn}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
   \includegraphics[width=\linewidth]{graphics/random_hist_3}
  \captionof{figure}{Random transformation approximation error distribution for $r=1$.}
  \label{fig:as_nn}
\end{subfigure}
\delimit
\captionof{figure}{Differences in sample selection between the two neighbour approximation methods for examples with $|S|=10$.
