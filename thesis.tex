...
\begin{equation}
t(x_1,x_2)=\left[8 \left(x_1 \text{ mod } \frac{1}{8}\right), 8 \left(x_2 \text{ mod } \frac{1}{8}\right)\right]^T.
\nonumber
\end{equation}
To illustrate the improvement in multiple smaller steps, we also investigate periodic transformations with several configurations $p \in \{\frac{1}{8}, \frac{1}{4}, \frac{1}{2}, 1\}$ in \cref{fig:periodic}.
...
\begin{minipage}{.49\textwidth}
        \centering
  \captionof{figure}{Approximation errors of various periodic transformations and sparse grid surrogates of level $l$, linear hat basis, and .. for the function $f_p$.}
    \end{minipage}%
    \begin{minipage}{0.49\textwidth}
        \centering
...
\begin{mdframed}[style=style,frametitle={Transformation pipeline example}]
\begin{figure}[H]
