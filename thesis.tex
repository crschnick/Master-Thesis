...
\begin{minipage}{.46\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{graphics/s}
...
\end{minipage}
\hspace{1cm}
\begin{minipage}{.446\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{graphics/s_unit}
...
The surrogate space $S$ can then be transformed into a unit hypercube $\Omega_R$ with \eqref{alignment}, i.e. $a(S)=\Omega_R$, and therefore the transformation function can be defined as follows:
\begin{equation}
t_{\text{Cube}}(x)=a(p(x))
\end{equation}
