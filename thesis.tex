...
The basis functions are chosen to be nodal basis functions that fullfil $\phi_{\ell,i}(x_{\ell,j})=\delta_{ij}$, as they allow for a very convenient interpolation.
