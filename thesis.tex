...
In the context of the sparse grid types used in thesis we assume $L=\mathds{N}_0$ .
...
The interpolation method is the most simple and common one.
...
Another method of constructing the surrogate is by using regression \cite{}.
