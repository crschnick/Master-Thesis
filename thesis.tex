...
There already exist various approach to dimension reduction in the context of sparse grids, such as various types of adaptive sparse grids or sparse grid based Analysis of Variance (ANOVA), where the goal is to neglect less important dimensions of model functions.
...
Recently Active Subspaces have been applied in combination with sparse grids \cite{}, and we now combine them with regression on spatially adaptive sparse grids \cite{P10}.
