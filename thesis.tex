...
To get an idea of the actual quality of the different methods, especially regarding the resulting active subspace error $\varepsilon_{\text{AS}}$, this section will focus purely on the gradient approximation methods to gauge whether the methods can be used to generate meaningful input transformations.
...
\begin{equation}
t_p(x_1,x_2)=\left[8 \left(x_1 \text{ mod } p\right), 8 \left(x_2 \text{ mod } p\right)\right]^T.
\nonumber
\end{equation}
